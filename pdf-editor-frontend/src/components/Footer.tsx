...
export default function Footer() {
  return (
    <footer className="bg-green-100/65 border-t border-gray-300 py-6">
      <div className="max-w-screen-xl mx-auto px-4 flex flex-col sm:flex-row justify-between items-center text-gray-600 text-md">
